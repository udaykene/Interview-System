      ...
      <div style={{ flex: 1, display: "flex", justifyContent: "center", alignItems: "center", padding: "0 20px" }}>
        <motion.div {...fadeUp(0.1)} style={{
          ...
          <motion.div {...fadeUp(0.15)} style={{ textAlign: "center", marginBottom: 32 }}>
            ...
            <p style={{ fontSize: 14, color: "var(--text-muted)" }}>Sign in to your CodeArena account</p>
          </motion.div>

          {/* Social Login */}
          <motion.div {...fadeUp(0.2)} style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 28 }}>
          ...
          <div className="divider" style={{ marginBottom: 28 }}>or</div>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
            ...
            <motion.div {...fadeUp(0.3)} className="input-group">
            ...
            <motion.button {...fadeUp(0.35)} type="submit" disabled={loading} className="btn btn-primary btn-full"
              style={{ marginTop: 8, padding: '13px', borderRadius: 12 }}>
              {loading ? <div className="spinner" style={{ width: 16, height: 16 }} /> : <>Sign in <ArrowRight size={14} /></>}
            </motion.button>
          </form>

          <motion.div {...fadeUp(0.4)} style={{ marginTop: 28, display: 'flex', flexDirection: 'column', gap: 10, textAlign: 'center' }}>
            <Link to="/forgot-password" style={{ fontSize: 13, color: 'var(--text-muted)', textDecoration: 'none' }}>
              Forgot your password? <span style={{ color: 'var(--accent-violet-light)' }}>Reset it</span>
            </Link>
            <span style={{ fontSize: 13, color: 'var(--text-muted)' }}>
              Need an account? <Link to="/signup" style={{ color: 'var(--accent-violet-light)', textDecoration: 'none' }}>Sign up</Link>
            </span>
          </motion.div>
        </motion.div>
      </div>
